...
const BASE_PROMPTS = {
  essayOrBlog: `Generate a title and outline for an essay based on the following passage. Provide 1-3 sub-bullets for each section of the outline. Make the section headings creative.`,
...
const generateAction = async (req, res) => {
  ...
  console.log(`BP!! --- ${buildBasePrompt({promptType, userInput, complexity})}`);
  ...
  console.log({ basePromptCompletion });
